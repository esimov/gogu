...
Torx is a versatile, comprehensive, reusable and efficient utility functions and data structures library taking advantage of the Go generics. It was inspired by other well established and consecrated frameworks like underscore.js, lodash and some concepts familiar to the functional programming paradigms. 

Its main purpose is to help the developers in their day-to-day jobs by exposing some generic helper functions, like a donsens of functions facilitating the work with slices, maps and strings, but also implementing some of the most used data structures.
